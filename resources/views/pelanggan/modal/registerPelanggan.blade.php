<div class="modal fade" id="registerModal" tabindex="-1" aria-labelledby="registerModalLabel" aria-hidden="true">
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-9">
      <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Input Addreess 1" required>
    </div>
  </div>
  <div class="mb-3 row">
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-9">
      <input type="date" class="form-control" id="date" name="date" placeholder="Input Phone Number">
        ...
        <p class="m-auto text-center p-2" style="font-size:12px">Jika belum mempunyai akun register sekarang .. !</p>
